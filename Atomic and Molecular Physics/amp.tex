...
% PART B
    ...
    \begin{entry}
        ...
        \options{
            \option{A} & 24.6 J & \option{B} & 22.4 J \\
            \option{C} & 98 J & \option{D} & 48 J \\
        }    
    \end{entry}
    ...
    \begin{entry}
        ...
        \options{
            \option{A} & 12 pm & \option{B} & 10 pm \\
            \option{C} & 8 pm & \option{D} & 6 pm \\
        }    
    \end{entry}
    ...
    \begin{entry}
        ...
        \options{
            \option{A} & $^1F_3$ & \option{B} & $^1S_0$ \\
            \option{C} & $^1D_2$ & \option{D} & $^3P_0$ \\
        }    
    \end{entry}
